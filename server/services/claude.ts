...
export async function analyzeStaticAd(imageUrl: string, brandName: string): Promise<string> {
  ...
  content.push({
    type: "text",
    text: `Analyze this competitor static advertisement from ${brandName}. Provide detailed analysis covering:
1. Visual composition and layout
2. Color palette and branding
3. Typography and text hierarchy
4. Product presentation
5. Call-to-action effectiveness
6. Emotional appeal and messaging
7. Target audience alignment
8. Key takeaways for ONEST Health

Provide specific, actionable recommendations for how ONEST Health can create superior static creatives.`,
  });

  return callClaude([{ role: "user", content: content }], system, 4000);
}
